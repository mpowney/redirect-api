...
namespace api.v1
{
    public static class Test
    {
            ...
            ClaimsPrincipal claimsPrincipal)
        {
            ...
            return new OkObjectResult($"Success\n\n{claimsPrincipal.Identity.Name}\n\n{string.Join("\n", claimsPrincipal.Claims.Select(claim => { return $"{claim..Subject.Actor} - {claim.Subject.RoleClaimType} - {claim.Subject.NameClaimType} - {claim.Subject.Label} - {claim.Subject.Name} - {claim.ValueType} - {claim.Value}"; }))}");
